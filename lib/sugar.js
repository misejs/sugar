...
sugar.setup = function(app,modelPath,options,done){
  ...
  app.get('/admin',auth.authenticate,admin.home);
  Object.keys(models).forEach(function(name){
    var Model = models[name];
    var collection = Model.prototype.collection;
    app.get('/admin/' + collection, auth.authenticate, admin.index);
    app.get('/admin/' + collection + '/create', auth.authenticate, admin.create);
    app.get('/admin/' + collection + '/:id', auth.authenticate, admin.update);
  });
